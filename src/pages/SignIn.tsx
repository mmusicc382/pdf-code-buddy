...
const SignIn = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Demo login - in production, integrate with backend
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Purple Header */}
      <div className="gc-gradient h-32 md:h-40" />

      {/* Form Card */}
      <div className="flex-1 bg-card -mt-8 rounded-t-4xl px-6 py-10 md:px-10">
